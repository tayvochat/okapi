...
impl<'a> OpenApiFromRequest<'a> for ApiKey {
    ...
    fn get_responses(gen: &mut OpenApiGenerator) -> tayvo_rocket_okapi::Result<Responses> {
        use tayvo_rocket_okapi::tayvo_okapi::openapi3::RefOr;
        ...
        match use_method {
            ...
            "2nd alternative" => {
                ...
                // Add "400 BadRequest"
                tayvo_rocket_okapi::util::add_schema_response(
                    &mut responses,
                    400,
                    "application/json",
                    schema.clone(),
