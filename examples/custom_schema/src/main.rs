use tayvo_rocket_okapi::tayvo_okapi::openapi3::OpenApi;
use tayvo_rocket_okapi::settings::UrlObject;
use tayvo_rocket_okapi::{mount_endpoints_and_merged_docs, rapidoc::*, swagger_ui::*};
...
pub fn create_server() -> Rocket<Build> {
    ...
    let openapi_settings = tayvo_rocket_okapi::settings::OpenApiSettings::default();
