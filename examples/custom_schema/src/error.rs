use tayvo_rocket_okapi::tayvo_okapi::openapi3::Responses;
use tayvo_rocket_okapi::tayvo_okapi::schemars::{self, Map};
use tayvo_rocket_okapi::{gen::OpenApiGenerator, response::OpenApiResponderInner, OpenApiError};
use rocket::{
...
impl OpenApiResponderInner for Error {
    fn responses(_generator: &mut OpenApiGenerator) -> Result<Responses, OpenApiError> {
        use tayvo_rocket_okapi::tayvo_okapi::openapi3::{RefOr, Response as OpenApiReponse};
