...
/// ### Example
/// ```rust,ignore
/// use tayvo_rocket_okapi::openapi;
/// use rocket::get;
///
/// #[openapi]
/// #[get("/hello/<number>")]
...
/// - `spec_opt`: `Option<rocket_okapi::tayvo_okapi::openapi3::OpenApi>`
...
/// let spec = tayvo_rocket_okapi::openapi_spec![get_message, post_message](settings.clone());
/// let routes = tayvo_rocket_okapi::openapi_routes![get_message, post_message](Some(spec), settings);
/// ```
#[proc_macro]
...
/// - `settings`: `rocket_okapi::settings::OpenApiSettings`
///
/// It returns `rocket_okapi::tayvo_okapi::openapi3::OpenApi`.
///
/// Example:
/// ```rust,ignore
/// let settings = tayvo_rocket_okapi::settings::OpenApiSettings::new();
/// let spec = tayvo_rocket_okapi::openapi_spec![get_message, post_message](settings);
/// ```
#[proc_macro]
...
/// Use:
/// ```rust,ignore
/// use tayvo_rocket_okapi::request::OpenApiFromRequest;
///
...
pub fn open_api_from_request_derive(input: TokenStream) -> TokenStream {
    ...
    let gen = quote! {
        impl<'r> tayvo_rocket_okapi::request::OpenApiFromRequest<'r> for #name {
            fn from_request_input(
                _gen: &mut tayvo_rocket_okapi::gen::OpenApiGenerator,
                _name: String,
                _required: bool,
            ) -> tayvo_rocket_okapi::Result<tayvo_rocket_okapi::request::RequestHeaderInput> {
                Ok(tayvo_rocket_okapi::request::RequestHeaderInput::None)
            }
        }
    };
    gen.into()
